package onlinestore.gateway.security;
...
public class RouterValidator {
    ...
    public static final List<Pattern> openEndpoints = List.of(
            ...
            Pattern.compile("/order/api/v3/api-docs"),
            Pattern.compile("/payment/api/v3/api-docs"),
            Pattern.compile("/inventory/api/v3/api-docs"),
            Pattern.compile("/delivery/api/v3/api-docs")
    );
